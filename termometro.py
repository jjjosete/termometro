...
class Selector():
    ...
    def __init__(self, unidad = 'C'):
        self.__customes = []
        self.__customes.append(pygame.image.load('termometro/posiF.png'))
        self.__customes.append(pygame.image.load('termometro/posiC.png'))
...
class NumberInput():
    ...
    def render(self):
        ...
        rect.left = self.__size[0]
        rect.top = self.__size[1]
